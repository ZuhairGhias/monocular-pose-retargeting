...
- A first `src/retargeting/` scaffold exists with shared types, a Mixamo body mapping, and a naive direction retargeter.
...
- Add a refined retargeting method alongside the naive one for smoothing, confidence-aware blending, joint limits, and later IK.
